...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Adiciona marcadores para as clínicas/veterinários em destaque
    const locaisDestaque = [
        { nome: 'Dra. Ana Silva', lat: -25.4284, lng: -49.2733, especialidade: 'Dermatologia' },
        { nome: 'Dr. Carlos Mendes', lat: -25.5284, lng: -49.2033, especialidade: 'Cardiologia' },
        { nome: 'Dra. Mariana Costa', lat: -25.4684, lng: -49.3033, especialidade: 'Ortopedia' }
    ];
